...
public class MovingBackgroundView extends  View {
    ...
    public void draw(SpriteBatch batch){
        batch.draw(texture, 0, texture1Y, GameSettings.SCREEN_WIDTH, GameSettings.SCREEN_HEIGHT+7);
        batch.draw(texture, 0, texture2Y, GameSettings.SCREEN_WIDTH, GameSettings.SCREEN_HEIGHT+7);
    }
    @Override
    public void dispose(){
        texture.dispose();
